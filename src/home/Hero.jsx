    ...
    <>
      ...
      >
        <div className="flex lg:flex-row flex-col-reverse items-center justify-between gap-9">
          ...
          >
            ...
            <div className="w-full lg:max-w-[79%]">
              ...
              <p className="mt-5 text-white  lg:text-start md:text-center leading-[1.5]">
                Dive in to explore my projects, learn about my skills, and
                discover how I can bring your vision to life. Let's create
            ...
            <div className="flex gap-3">
              ...
              <a
                href="https://docs.google.com/document/d/1ieIjE6jOXKS6X_BjYg_oRwQfiEDbhyBi/edit"
                target="_blank"
                className="flex text-blue-500 font-bold hover:shadow-2xl lg:mx-0 md:mx-auto duration-300 hover:shadow-blue-500/50 w-[179px] border-solid border-2 border-blue-500 rounded-lg items-center gap-3 justify-center py-2 "
              >
          ...
          >
            <img
              className="rounded-lg ml-auto w-full lg:h-[550px] object-cover"
              src={heroImage}
              alt="avatar"
            />
          </div>
